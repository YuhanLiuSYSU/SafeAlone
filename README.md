...
required. For some reason, your email and password should be entered in a hardcore way. Just go to "SafeAlone\app\src\main\java\com\example\safealone\LongOperation.java" and set "sender_email" and "pwd". And in your gmail setting, change account access for less secure apps https://www.google.com/settings/security/lesssecureapps
